        ...
        <ul className="mt-4 space-y-2 pl-8 md:pl-12">
          <li>
            <a href="#" className="block h-full p-4 border-l-4 border-transparent hover:border-primary-dark">
              ...
              Independent instrucDon of public speaking courses - lesson design, planning, and implementation.
              </p>
            </a>
          </li>
          <li>
            <a href="#" className="block h-full p-4 border-l-4 border-transparent hover:border-primary-dark">
              ...
              <p className="mt-1 text-sm md:text-md font-medium text-primary-dark">
              Student advising and management, assessment, substitute teaching,
facilitation of online migration during COVID, technological management.
              </p>
            </a>
          </li>
          <li>
        ...
        <ul className="mt-4 space-y-2 pl-8 md:pl-12">
          ...
          <li>
            <a href="#" className="block h-full p-4 border-l-4 border-transparent hover:border-primary-dark">
              ...
              <p className="mt-1 text-sm md:text-md font-medium text-primary-dark">
              Fall – Spring 2015. Sally’s Saloon, Minneapolis. Adapted to and developed insights into business trends for effective staffing and labor costs.
              </p>
            </a>
          </li>
          <li>
