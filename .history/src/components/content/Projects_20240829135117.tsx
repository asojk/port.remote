	...
	<div>
		<div className='py-12'>
			<div className='m-auto px-6 text-gray-600 xl:container md:px-12 xl:px-6'>
				...
				<h4 className='-px-2 pt-6 text-xl font-semibold text-violet-400 md:text-2xl pb-12'>Web Development Projects</h4>
		...
		<div className='py-12'>
			<div className='m-auto px-6 text-gray-600 xl:container md:px-12 xl:px-6'>
      <h4 className='-px-2 pt-6 text-xl font-semibold text-violet-400 md:text-2xl pb-12'>Research & Writing</h4>
				<div className='grid gap-12 md:grid-cols-2 md:gap-6 lg:gap-12'>
					<div className='group space-y-6'>
						<a
		...
		<div className='py-12'>
			<div className='m-auto px-6 text-gray-600 xl:container md:px-12 xl:px-6'>
      <h4 className='-px-2 pt-6 text-xl font-semibold text-violet-400 md:text-2xl pb-12'>Other Design</h4>
				<div className='grid gap-12 md:grid-cols-2 md:gap-6 lg:gap-12'>
					<div className='group space-y-6'>
		...
		<div className='py-12'>
			<div className='m-auto px-6 text-gray-600 xl:container md:px-12 xl:px-6'>
      <h4 className='-px-2 pt-6 text-xl font-semibold text-violet-400 md:text-2xl pb-12'>Marketing & Copywriting</h4>
				<div className='grid gap-12 md:grid-cols-2 md:gap-6 lg:gap-12'>
					<div className='group space-y-6'>
