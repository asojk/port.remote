	...
	<div>
		...
		<div className=''>
			...
			<h2 className="title-font mb-4 text-2xl font-medium text-primary-light">Audio/Video Production</h2>
				<div className='grid gap-12 md:grid-cols-2 md:gap-6 lg:gap-12 px-4 mx-4 md:px-8 md:mx-12'>
					<ReactPlayer width={300} height={400} url='https://www.youtube.com/embed/Otw5hEvxpls?si=fosdR9ConvHcvWTE' />
					<ReactPlayer width={300} height={400} url='https://grell.s3.us-east-2.amazonaws.com/Smid3.mp4'/>
					<ReactPlayer width={300} height={400} url='https://www.youtube.com/embed/A8RSHC4eqPU?si=GlYmxRAocN04wSsz' />
					<ReactPlayer width={300} height={400} url='https://www.youtube.com/embed/zqihHHFhJbo?si=leFLNjM6oDt19yNZ' />
					<ReactPlayer width={300} height={400} url='https://www.youtube.com/embed/M0MJxnTyj8M?si=J0siFDXrQTFcnl6D' />
