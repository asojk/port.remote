  ...
  <div className="body-font text-gray-400 py-12">
    <section className="container mx-auto px-5">
      ...
      <div className="flex h-full items-center rounded-full border-b-[2px] border-primary/10 p-4 shadow-sm shadow-primary/40">
          ...
          <div>
            <h3 className="text-lg font-medium text-violet-400">M.A. - Intersection of Identity and Technology</h3>
        ...
        <ul className="mt-4 space-y-2">
          <li>
            <a href="#" className="block h-full rounded-lg  p-4 ">
              <strong className="title-font font-medium text-primary-light">Digital Conditions of Self</strong>
