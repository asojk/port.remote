    ...
    <section className="body-font text-gray-400">
      <div className="container mx-auto px-5 py-24">
        <div className="mb-4 text-center">
          <h1 className="title-font mb-4 text-center text-2xl font-medium text-white sm:text-3xl bg-red-300 animate-background-shine ">
            Hi all, I'm Alex.
          </h1>
      ...
      <div className="m-auto px-6 text-gray-600 xl:container md:px-12 xl:px-6">
        <div className="grid gap-12 md:grid-cols-2 md:gap-6 lg:gap-12">
          <div className="group space-y-6">
            <p className="text-center text-2xl font-medium text-white sm:text-3xl">
            Hobbies - <br></br>
                drone photos
                <br></br>
                Hockey
                ...
                <br></br>
                DIY or thrifting? What’s your latest find or build?
                  gimme random pieces and I’ll make something 
                  <br></br>
                Music
                <br></br>
                Marlow
