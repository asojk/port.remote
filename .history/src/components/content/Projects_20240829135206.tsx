	...
	<div>
		<div className='py-12'>
			<div className='m-auto px-6 text-gray-600 xl:container md:px-12 xl:px-6'>
				...
				<h3 className='-px-2 pt-6 text-2xl font-semibold text-violet-400 md:text-3xl pb-12'>Web Development Projects</h3>
				<div className='grid gap-12 md:grid-cols-2 md:gap-6 lg:gap-12'>
					<div className='group space-y-6'>
						...
						<h4 className='text-xl font-semibold text-primary-light'>Deck Renew</h4>
					...
					<div className='group space-y-6'>
						...
						<h4 className='text-xl font-semibold text-primary-light'>Grell Roofing</h4>
						<p className='text-gray-600 dark:text-gray-300'>
					...
					<div className='group space-y-6'>
						...
						<h4 className='text-xl font-semibold text-primary-light'>Northeast Iowa Food Bank</h4>
						<p className='text-gray-600 dark:text-gray-300'>
		...
		<div className='py-12'>
			<div className='m-auto px-6 text-gray-600 xl:container md:px-12 xl:px-6'>
      <h3 className='-px-2 pt-6 text-2xl font-semibold text-violet-400 md:text-3xl pb-12'>Research & Writing</h3>
				<div className='grid gap-12 md:grid-cols-2 md:gap-6 lg:gap-12'>
					<div className='group space-y-6'>
						<a
						...
						<h4 className='text-xl font-semibold text-primary-light'>Research Publication</h4>
						<p className='text-gray-600 dark:text-gray-300'>
					...
					<div className='group space-y-6'>
						...
						<h4 className='text-xl font-semibold text-primary-light'>Newsletter Campaigns</h4>
						<p className='text-gray-600 dark:text-gray-300'>
		...
		<div className='py-12'>
			<div className='m-auto px-6 text-gray-600 xl:container md:px-12 xl:px-6'>
      <h3 className='-px-2 pt-6 text-2xl font-semibold text-violet-400 md:text-3xl pb-12'>Other Design</h3>
				<div className='grid gap-12 md:grid-cols-2 md:gap-6 lg:gap-12'>
					<div className='group space-y-6'>
						...
						<h4 className='text-xl font-semibold text-primary-light'>CAD / 3D Design</h4>
						<p className='text-gray-600 dark:text-gray-300'>
		...
		<div className='py-12'>
			<div className='m-auto px-6 text-gray-600 xl:container md:px-12 xl:px-6'>
      <h3 className='-px-2 pt-6 text-2xl font-semibold text-violet-400 md:text-3xl pb-12'>Marketing & Copywriting</h3>
				<div className='grid gap-12 md:grid-cols-2 md:gap-6 lg:gap-12'>
					<div className='group space-y-6'>
						...
						<h4 className='text-xl font-semibold text-primary-light'>Email Marketing</h4>
						<p className='text-gray-600 dark:text-gray-300'>
            ...
            <div className='flex gap-4'>
					...
					<div className='group space-y-6'>
						...
						<h4 className='text-xl font-semibold text-primary-light'>Social Media Marketing</h4>
						<p className='text-gray-600 dark:text-gray-300'>
