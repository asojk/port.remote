					...
					<div className='group space-y-2'>
						<a href='https://www.grellcommercialroofing.com' className='cursor-pointer'>
							<img
								...
								width='1000'
								height='667'
								className='h-36 w-full rounded-3xl bg-white object-contain object-center transition-all duration-500 group-hover:rounded-xl'
							/>
						</a>
						<h4 className='text-xl font-semibold text-primary-light md:text-2xl pl-2'>Grell Roofing</h4>
