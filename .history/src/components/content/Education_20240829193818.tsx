export const EducationContent = () => (
  <div className="body-font text-gray-400 py-12">
    <section className="container mx-auto px-5">
      ...
      <div className="flex h-full items-center rounded-full border-b-[2px] border-violet-400 p-4 shadow-sm shadow-primary/40">
        ...
        <ul className="mt-4 space-y-2">
          <li>
            <a href="#" className="block h-full rounded-lg border border-gray-700 p-4 hover:border-pink-600">
              <strong className="font-medium text-primary-light">Digital Conditions of Self</strong>
