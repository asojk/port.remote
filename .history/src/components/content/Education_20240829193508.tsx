export const EducationContent = () => (
  <div className="body-font text-gray-400 py-12">
    <section className="container mx-auto px-5">
      ...
      <article className="rounded-xl border border-gray-700 bg-gray-800 p-4 mb-12">
      <div className="flex h-full items-center rounded-full border-b-[1px] border-primary/10 p-4 shadow-sm shadow-primary/40">
