export const EducationContent = () => (
  <div className="body-font text-gray-400 py-12">
    <section className="container mx-auto px-5">
      ...
      <div className="flex h-full items-center border-b-[2px] border-primary/10 p-4 shadow-sm shadow-primary/40">
          ...
          <div>
            <h3 className="text-lg md:text-2xl font-medium mb-1 text-violet-400">M.A. - Intersection of Identity and Technology</h3>
            <p className="title-font font-medium text-md md:text-lg text-primary-dark">
        ...
        <ul className="mt-4 space-y-2 pl-8 md:pl-12">
          <li>
            <a href="#" className="block h-full p-4 border-l-2 border-transparent hover:border-primary-dark">
              <strong className="text-lg font-medium text-primary-light">Digital Conditions of Self</strong>
