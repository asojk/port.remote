...
export const ProjectsAndAchievementsContent = () => (
	<div>
					...
					<div className='group space-y-6'>
						<a href='https://www.deckrenew.net' className='cursor-pointer'>
							<img
								...
								width='1000'
								height='667'
								className='h-56 w-full rounded-3xl bg-white object-contain p-4 object-center transition-all duration-500 group-hover:rounded-xl'
							/>
						</a>
					...
					<div className='group'>
						<a href='https://www.grellcommercialroofing.com' className='cursor-pointer'>
							<img
								...
								width='1000'
								height='667'
								className='h-36 w-full rounded-3xl bg-white object-contain object-center transition-all duration-500 group-hover:rounded-xl mb-2'
							/>
						</a>
						<h4 className='text-lg font-semibold text-primary-dark md:text-xl pl-2'>Grell Roofing</h4>
						<p className='text-primary-light pl-2 mb-2'>
			...
			<div className='mb-12 space-y-2 text-center'>
				...
				<div className='mx-4 grid gap-12 px-4 md:mx-12 md:grid-cols-2 md:gap-6 md:px-8 lg:gap-12'>
					<div className='group space-y-6'>
						...
						<p className='text-primary-light'>
							Pardot, MailChimp, and Constant Contact are just a few of the platforms I have used to develop and manage
					...
					<div className='group space-y-6'>
						...
						<p className='text-primary-light'>
							Implemented strategic, unified social media marketing campaigns for various organizations across all major
		...
		<div className='m-auto px-6 text-gray-600 xl:container md:px-12 xl:px-6 py-12'>
		<div className='mb-12 space-y-2 text-center'>
					<h1 className='title-font mb-2 text-center text-2xl font-medium text-white sm:text-3xl'>
						Some Past Projects
					</h1>
			...
			<p className='text-lg text-primary-light'>
				I have produced and edited television advertisements, instructional videos, drone videography as well as
				promotional and educational content for various organizations.
			</p>
			<p className='text-lg text-primary-light'>
				Instead of embedding videos here (which allows YouTube to track your views, and clogs my site with other
				unnecessary code), I'll provide some links to some channels I've contributed to:
			</p>
