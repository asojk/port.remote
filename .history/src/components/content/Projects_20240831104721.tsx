...
export const ProjectsAndAchievementsContent = () => (
	<div>
      ...
      <div className='m-auto px-6 pt-12 text-gray-600 xl:container md:px-12 xl:px-6'>
        ...
        <div className='grid gap-8 md:grid-cols-2 lg:grid-cols-3 px-4 mx-4 md:px-8 md:mx-12'>
          <div className='overflow-hidden rounded-3xl bg-black'>
\
			<YouTube url='https://www.youtube.com/embed/Otw5hEvxpls?si=fosdR9ConvHcvWTE' />
			<YouTube ID='fosdR9ConvHcvWTE' />
          </div>
          <div className='overflow-hidden rounded-3xl bg-black'>
			<YouTube 
              url='https://grell.s3.us-east-2.amazonaws.com/Smid3.mp4'
            />
          </div>
          <div className='overflow-hidden rounded-3xl bg-black'>
			<YouTube 
              url='https://www.youtube.com/embed/A8RSHC4eqPU?si=GlYmxRAocN04wSsz'
            />
          </div>
          <div className='overflow-hidden rounded-3xl bg-black'>
            <YouTube
              url='https://www.youtube.com/embed/zqihHHFhJbo?si=leFLNjM6oDt19yNZ'
            />
          </div>
          <div className='overflow-hidden rounded-3xl bg-black'>
            <YouTube
              url='https://www.youtube.com/embed/M0MJxnTyj8M?si=J0siFDXrQTFcnl6D'
            />
          </div>
        </div>
      </div>
