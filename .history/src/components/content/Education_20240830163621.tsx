  ...
  <div className="body-font text-gray-400 py-12">
    <section className="container mx-auto">
      ...
      <div className="flex h-full items-center border-b-[2px] border-primary-dark md:p-4">
          ...
          <div>
            <h3 className="text-lg ml-4 md:ml-0 md:text-2xl font-medium mb-1 text-primary-light">M.A. - Intersection of Identity and Technology</h3>
            <p className="title-font md:ml-0 font-medium ml-4 text-md md:text-lg text-violet-400">
