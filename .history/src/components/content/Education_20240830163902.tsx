export const EducationContent = () => (
  <div className="body-font text-gray-400 py-12">
    <section className="container mx-auto">
      ...
      <article className="rounded-xl md:p-4 mb-8">
      <div className="flex h-full items-center border-b-[2px] p-2 border-primary-dark md:p-4">
          ...
          <div>
            <h3 className="text-lg ml-2 md:text-2xl font-medium mb-1 text-primary-light">M.A. - Intersection of Identity and Technology</h3>
            <p className="title-font ml-2 font-medium text-md md:text-lg text-violet-400">
      ...
      <article className="rounded-xl md:p-4mb-12">
      <div className="flex h-full items-center border-b-[2px] border-primary-dark md:p-4 p-2">
          ...
          <div>
            <h3 className="text-lg ml-2 md:text-2xl font-medium mb-1 text-primary-light">B.A. Communication Studies</h3>
            <p className="title-font ml-2 font-medium text-md md:text-lg text-[#ffcc33]">
