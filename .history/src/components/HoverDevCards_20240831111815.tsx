  ...
  return (
    <div className="p-4">
      <div className="grid gap-4 grid-cols-2 lg:grid-cols-4">
        <Card title='Music' subtitle='From gigs to production' href='https://www.youtube.com/@IfEyeMayMusic' Icon={FiMusic} />
        <Card title='Podcast Compilations' subtitle='Whether informative, thought provoking, or informational' href='https://www.youtube.com/@atsojka' Icon={PiApplePodcastsLogo} />
        ...
        <Card title='Drone Videography' subtitle="https://grell.s3.us-east-2.amazonaws.com/Smid3.mp4" href='#' Icon={FiVideo} />
      </div>
    </div>
  );
};
...
const Card = ({ title, subtitle, Icon, href }: CardType) => {
  return (
    <a
      href={href}
      className="w-full p-4 rounded border-[1px] border-success-content relative overflow-hidden group "
    >
