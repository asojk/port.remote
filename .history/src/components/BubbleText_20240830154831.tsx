...
const BubbleText = () => {
  ...
  return (
    <h2 className="hover-text grid grid-rows-3 text-center text-5xl font-thin text-indigo-300">
      <div><Text>1. Be still</Text></div>
      <div><Text>2. Be calm</Text></div>
      <div><Text>3. Be happy</Text></div>
    </h2>
  );
};
