...
const BubbleText = () => {
  ...
  return (
    <h2 className="hover-text grid grid-rows-3 space-y-4 text-center text-5xl font-thin text-violet-400">
      <div><Text>Be Still</Text></div>
      <div><Text>Be Calm</Text></div>
      <div><Text>Be Happy</Text></div>
    </h2>
  );
};
