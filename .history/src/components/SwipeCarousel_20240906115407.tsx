...
const imgs = [
    { src: '/fam.otter.webp', title: 'Family (& Matching Attire Photos)' },
    { src: '/fam.sharks.webp', title: 'with Sharks' },
    { src: '/mar2.webp', title: 'Marlow <3' },
    { src: '/resort.webp', title: 'Drone Videography' },
    { src: '/smit1.webp', title: '(cont.)' },
    { src: '/wild4.webp', title: 'Hockey!' },
  ];
