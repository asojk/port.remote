      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="relative cursor-default overflow-hidden rounded-lg bg-neutral-900 p-4 text-white shadow-xl"
          >
            <div className="relative z-10">
              ...
              <div className="scrollbar-thin scrollbar-thumb-neutral-700 scrollbar-track-neutral-800 relative z-0 h-[85vh] w-[85vw] overflow-y-auto p-2 pt-12 lg:max-w-7xl">
                {children}
              </div>
            </div>
          </motion.div>
