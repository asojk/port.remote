...
const AnimatedGridButtons = () => {
  ...
  return (
    <div className="mx-auto max-w-80 p-0 text-primary-content md:max-w-3xl md:p-4">
      ...
      <div className="pb-12 md:pb-2"></div>
    </div>
  );
};
  ...
  return (
    <div className="relative">
      ...
      <motion.button
        ...
        onClick={onClick}
        className="group relative flex h-32 w-full items-center border-[1.5px] border-copy-light bg-primary-light px-8 text-xl font-semibold hover:bg-error-content"
      >
        <Icon icon={icon} />
        <h2 className="relative z-10 text-2xl font-semibold leading-tight transition-all duration-500 group-hover:-translate-y-2 group-hover:text-primary-light">
          {title}
        </h2>
      </motion.button>
    </div>
