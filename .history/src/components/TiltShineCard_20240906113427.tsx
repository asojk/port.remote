...
export const TiltShineCard = () => {
  return (
    <div className="relative z-1 h-[25vh]">
      <TiltShine />
    </div>
  );
};
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-black bg-opacity-50 text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
          <h3 className="text-xl font-bold pointer-events-none">Resume</h3>
          <button className="mt-4 rounded bg-primary px-4 py-2 text-md font-semibold text-primary-content hover:bg-primary-dark">
